...
function alter_filename($filename) {
...
$directory = "images/";
$target_file = $directory . alter_filename( basename($_FILES["file"]["name"]) );
$checker = true;
...
if ($checker == false) {
  ...
  if (true) {
    $rand = rand();
    $target_file= $directory . $rand . alter_filename( basename($_FILES["file"]["name"]) );
  }
